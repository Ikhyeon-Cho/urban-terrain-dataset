...
While well-known datasets like [KITTI](https://www.cvlibs.net/datasets/kitti/) provide extensive data for robotic perception, they often fall short in addressing the specific needs of learning robot-specific traversability. That is, KITTI and similar datasets such as [Cityscapes](https://www.cityscapes-dataset.com/) and [nuScenes](https://www.nuscenes.org/), are mainly designed for general applications and may not capture the unique environmental and operational challenges faced by specific robots. On the other hand, the robot's own navigation experiences provide rich contextual information that is crucial for understanding and navigating complex urban terrains.
